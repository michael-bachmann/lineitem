...
export const ThreeSteps: StoryObj = {
  render: () => (
    <ol style={{ maxWidth: 920 }} className="grid grid-cols-1 gap-[18px] min-[861px]:grid-cols-3">
      <StepCard n={1} icon={<Icon.sync width={22} height={22} />} title="Sync" body="lineitem finds your recent Amazon and Target charges in YNAB and matches each one to the order behind it — every line item, ready to split." />
