...
// clashing. Photo and no-photo items share the same frame.
const FRAME =
  "relative h-[50px] w-[50px] flex-none overflow-hidden rounded-control border border-line bg-surface-3 shadow-[inset_0_1px_0_rgba(255,255,255,.5),inset_0_0_0_1px_rgba(0,0,0,.03)]";
...
export function Thumb({ src, alt = "" }: { src?: string | null; alt?: string }) {
  ...
  return (
    <div className={`${FRAME} flex items-center justify-center text-faint`} title="No product image">
